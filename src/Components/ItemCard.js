                        ...
                        <div className="w-9/12">
                                 ...
                                 <div className="w-3/12 rounded-lg">
                                           <img src={ item?.card?.info?.imageId?.length ? CDN_URL + item?.card?.info?.imageId : DEFAULT_RESTAURANT_IMG } 
                                                className="rounded-lg lg:w-full my-4 w-[100%] md:h-[60%] lg:h-40 h-[80%] lg:my-12 shadow-lg -top-1 shadow-zinc-400 relative" 
                                                alt="item_card_img"/> 
                                                <div className="px-2 py-1 md:p-2 lg:p-2 bg-white mx-2 md:mx-10 lg:mx-12 w-[18%] md:w-[10%] lg:w-[6%] 
