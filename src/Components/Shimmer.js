...
return <div className="w-full h-[80%] mt-[6%]">
            <div className="bg-slate-950 w-full h-1/6 sm:h-1/6  lg:h-1/4">
                  <div className="py-20">
                       ...
                       <GiHamburger 
                           className="w-12 h-8 p-1 pl-4 md:w-14 lg:w-14 lg:h-10 text-white block top-[24%] md:top-[30%] lg:top-[27%] 
                                      sm:top-[28%] mx-[42%]  md:mx-[46%] lg:mx-[48%] absolute"/>
                   </div>
                   <div>
            ...
            <div className="flex flex-wrap w-full md:w-full lg:w-11/12 lg:mx-auto md:mx-4 animate-pulse">
              <div className='m-10 md:m-8 lg:m-10 p-4 w-[300px] bg-slate-200  rounded-lg h-60 '></div>
              <div className='m-10 md:m-8 lg:m-10 p-4 w-[300px] bg-slate-200  rounded-lg h-60 '></div>
              <div className='m-10 md:m-8 lg:m-10 p-4 w-[300px] bg-slate-200  rounded-lg h-60 '></div> 
              <div className='m-10 md:m-8 lg:m-10 p-4 w-[300px] bg-slate-200  rounded-lg h-60 '></div>
              <div className='m-10 md:m-8 lg:m-10 p-4 w-[300px] bg-slate-200  rounded-lg h-60 '></div>
