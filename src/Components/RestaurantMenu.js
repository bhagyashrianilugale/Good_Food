...
return (
      <>
        <div className="text-center p-6 mt-[35%] sm:mt-[18%] md:mt-[10%] relative">              
             <h2 className="font-bold text-2xl md:text-3xl">{name}</h2>
                <div className=" bg-gradient-to-t from-gray-200 p-4 rounded-xl w-full md:w-6/12 m-auto">
                   <div className="h-80 sm:h-60 md:h-38 w-full rounded-xl bg-gray-50 border m-auto sm:flex justify-between">
                        <div className="m-1">
                             <p className="font-bold my-2 mx-4 text-left md:mx-4">
                         ...
                         <img src={cloudinaryImageId ? CDN_URL+cloudinaryImageId : DEFAULT_RESTAURANT_IMG  }
                              className="w-[80%] p-0 h-[40%] sm:h-[80%] mx-auto md:h-[80%] sm:w-60 sm:m-6 md:w-60 shadow-lg shadow-slate-400 rounded-lg 
