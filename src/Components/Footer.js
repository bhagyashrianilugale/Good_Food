...
const Footer = () => {
  return (
    <footer className="bg-black text-white md:py-6 lg:py-10 -top-0 w-full">
      <div className="block sm:hidden py-10 md:hidden text-white text-center bottom-0 sticky">goodfood@gmail.com</div>
