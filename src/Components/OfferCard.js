...
return (
     <>
         <div className="flex sm:w-3/4 md:w-3/4 lg:w-6/12 w-full overflow-x-scroll no-scrollbar m-auto">
               { offers?.map((offer, index)=> <div key={index} className="w-80 h-[16%] sm:h-[14%] md:h-[14%] lg:h-[20%] flex 
                                                        mx-8 sm:mx-6 md:mx-6 lg:mx-6 text-black border border-x-gray-300 p-2 rounded-3xl">
