...
const About = () => {
   ...
   return (
       <div className="h-full mt-[28%] sm:mt-[12%] md:mt-[12%] lg:mt-[6%]">
           <div className="flex-none  sm:flex sm:flex-1  md:flex md:flex-1  lg:flex lg:flex-1 bg-orange-500 text-white">
                    <div className="p-4 lg:p-6 lg:m-auto w-full lg:w-[40%] text-center sm:text-left md:text-left lg:text-left">
                   ...
                   <div className="mt-8">
                        <img 
                           src={require("../assets/Delivery-boy.jpg")}
                            className="w-20 hidden sm:block  sm:w-40 md:w-40 lg:w-60 sm:mx-40 md:mx-40 lg:mx-40 transform cursor-pointer 
                                       transition-transform duration-500 scale-x-[-1] hover:-translate-x-20"
                        />
                    </div>
            </div>
           <div className="flex-none sm:flex sm:flex-1  md:flex md:flex-1 lg:flex-1 lg:flex bg-white text-orange-500">
               <div className="mt-8">
                        <img 
                            src={require("../assets/Delivery-boy.jpg")}                            
                            className="w-40  sm:w-40 sm:mx-20 md:w-40 md:mx-20 lg:w-60 mx-auto lg:mx-40 cursor-pointer  transform 
